...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.create_contact(wd, Group(name="Jan", middlename="Adam", lastname="Nowak", nickname="jnow", title="mr", company="Intel", address="Starowiejska 10/4", home="400340340", mobile="\\9",
    ...
    def create_contact(self, wd, group):
        ...
        wd.find_element_by_name("work").send_keys(group.mobile)
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").send_keys(group.mobile)
